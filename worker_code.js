  ...
  async fetch(request, env, ctx) {
    ...
    if (isStacked) {
      ...
      function renderSlot(src, y) {
        ...
        return "<rect x=\"0\" y=\"" + y + "\" width=\"" + imageWidth + "\" height=\"" + imageHeight + "\" fill=\"#1a1a1a\"/><text x=\"50%\" y=\"" + (midY - 12) + "\" dominant-baseline=\"middle\" text-anchor=\"middle\" font-family=\"sans-serif\" font-weight=\"bold\" font-size=\"28\" fill=\"#e74c3c\">CAMERA KEY NOT FOUND</text><text x=\"50%\" y=\"" + (midY + 20) + "\" dominant-baseline=\"middle\" text-anchor=\"middle\" font-family=\"sans-serif\" font-size=\"18\" fill=\"#bdc3c7\">Check your image key</text>";
      }

      const compositeSvg = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"" + imageWidth + "\" height=\"" + layout.h + "\"><rect width=\"100%\" height=\"100%\" fill=\"none\"/>" + renderSlot(src1, 0) + renderSlot(src2, bottomY) + "</svg>";
...
function generateFallback(width, height, customMsg) {
  if (!customMsg) customMsg = "IMAGE UNAVAILABLE";
